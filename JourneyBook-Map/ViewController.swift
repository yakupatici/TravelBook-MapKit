...
class ViewController: UIViewController ,MKMapViewDelegate , CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if selectedTitle != "" {
            ...
            let context = appDelegate.persistentContainer.viewContext // Fix the typo here
    ...
    @IBAction func saveButton(_ sender: Any) {
        ...
        navigationController?.popViewController(animated: true) //  eski view controlleera götürür
